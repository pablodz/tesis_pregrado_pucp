...
\begin{table}[H]
	...
	\begin{tabular}{|
		...
		\cellcolor[HTML]{A6A6A6}{\color[HTML]{000000} \textbf{HELIOS 25}} &
		\cellcolor[HTML]{A6A6A6}{\color[HTML]{000000} \textbf{APOLLO}} &
		\cellcolor[HTML]{A6A6A6}{\color[HTML]{000000} \textbf{\begin{tabular}[c]{@{}c@{}}PENTAIR\\ V-10000140\end{tabular}}} \\ \hline
		...
		{\color[HTML]{000000} -} \\ \hline
		{\color[HTML]{000000} Suministro eléctrico ()} &
		...
		{\color[HTML]{000000} \begin{tabular}[c]{@{}l@{}}Mínima velocidad de \\ entrada de caudal ()\end{tabular}} &
		{\color[HTML]{000000} -} &
		{\color[HTML]{000000} 40} &
		{\color[HTML]{000000} Bombeo de peces} &
		{\color[HTML]{000000} -} \\ \hline
		{\color[HTML]{000000} Dimensiones ()} &
		{\color[HTML]{000000} 350x100x118} &
		{\color[HTML]{000000} 200x100x110} &
		{\color[HTML]{000000} 315x128x128} &
		{\color[HTML]{000000} -} \\ \hline
