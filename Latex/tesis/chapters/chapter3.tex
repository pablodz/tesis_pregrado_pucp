...
\begin{landscape}
	...
	\begin{longtable}{|
		...
		\begin{minipage}{\mymaxsizeofcontenttable}
				\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/tolva.png} \\ 
				\begin{myflushcenter}
					{\footnotesize Tolva}
				\end{myflushcenter}
		\end{minipage}}                     & \multicolumn{3}{c|}{
		\begin{minipage}{\mymaxsizeofcontenttable}
			\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/malla.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Malla}
			\end{myflushcenter}
		\end{minipage}}                             \\ \hline
		...
		\multicolumn{2}{c|}{		
		\begin{minipage}{\mymaxsizeofcontenttable}
			\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/inyeccion de caudal.png} \\ 
			\begin{myflushcenter}
		...
		\multicolumn{2}{c|}{
		\begin{minipage}{\mymaxsizeofcontenttable}
			\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/juego de pistones.png} \\ 
			\begin{myflushcenter}
		...
		\multicolumn{2}{c|}{
		\begin{minipage}{\mymaxsizeofcontenttable}
			\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/cadenas transportadoras.png} \\ 
			\begin{myflushcenter}
		...
		\begin{minipage}{\mymaxsizeofcontenttable}
			\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/filtro de tamano.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Filtros de tamaño}
			\end{myflushcenter}
		\end{minipage}} & \multicolumn{2}{c|}{
		\begin{minipage}{\mymaxsizeofcontenttable}
			\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/filtro unico.png} \\ 
			\begin{myflushcenter}
		...
		\multicolumn{2}{c|}{
		\begin{minipage}{\mymaxsizeofcontenttable}
			\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/multiples compuertas programables.png} \\ 
			\begin{myflushcenter}
		...
		\multicolumn{2}{c|}{
		\begin{minipage}{\mymaxsizeofcontenttable}
			\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/compuerta unica programable.png} \\ 
			\begin{myflushcenter}
		...
		\multicolumn{2}{c|}{
		\begin{minipage}{\mymaxsizeofcontenttable}
			\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/dimensionalidad.png} \\ 
			\begin{myflushcenter}
