...
\begin{mytable}[H]
    ...
    \resizebox{\textwidth}{!}{%
    	\begin{tabular}{l|c|c|c|c|c|c|}
    		\cline{2-7}
    		\multicolumn{1}{c|}{\textbf{}} & \cellcolor[HTML]{C0C0C0}\textbf{Modelo (Datasheet)} & \cellcolor[HTML]{C0C0C0}\textbf{I max (mA)} & \cellcolor[HTML]{C0C0C0}\textbf{V (Volts)} & \cellcolor[HTML]{C0C0C0}\textbf{P. Unitario (mW)} & \cellcolor[HTML]{C0C0C0}\textbf{Cant. (und.)} & \cellcolor[HTML]{C0C0C0}\textbf{Pot. tot (W)} \\ \hline
