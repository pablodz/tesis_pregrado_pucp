...
\begin{itemize}
	...
	Se escoge la válvula del fabricante Xhnotion modelo 2W debido a que si bien su diseño es más simple comparado con las alternativas, y usar Latón, cumple con el objetivo de regular la apertura de la compuerta que impide el paso de caudal de agua. 
...
\textcolor{blue}{[BORRADOR] Diagrama de PID [/BORRADOR]}
...
\subsubsection{Control de indicadores}
...
\begin{mytable}[H]
	...
	\begin{tabular}{l|c|c|c|c|c|c|}
		...
		\multicolumn{1}{|l|}{\cellcolor[HTML]{C0C0C0}\textbf{Motor a pasos 1 y 2}} & NEMA 34 & 2 & 24 & 53.85 & 2 & 96 \\ \hline
		\multicolumn{1}{|l|}{\cellcolor[HTML]{C0C0C0}\textbf{Driver de motor a pasos}} & DM860H & 7.2 & 24 & 71.8 & 2 & 172.8 \\ \hline
		...
		\multicolumn{1}{|l|}{\cellcolor[HTML]{C0C0C0}\textbf{Sensor de presión}} & WNK80MA & 20 & 5 & 43.08 & 4 & 40 \\ \hline
		\multicolumn{1}{|l|}{\cellcolor[HTML]{C0C0C0}\textbf{Electroválvula 1}} & 2W & - & 24 & 244.12 & 1 & $\approx$24 \\ \hline
		...
		\multicolumn{1}{|l|}{\cellcolor[HTML]{C0C0C0}\textbf{Indicador visual}} & HS-WS812B-16L-b & - & 5 & 12.57 & 3 & 3.80 \\ \hline
...
El diagrama esquemático presentado en la Figura \ref{fig:diagrama esquematico} y \ref{fig:diagrama de flujo2} es correspondiente al sistema de CCT, este ex8uhpone las conexiones de todos los componentes electrónicos utilizados. \textcolor{blue}{[BORRADOR] Explicar conexiones [/BORRADOR]}
