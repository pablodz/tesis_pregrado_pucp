...
\begin{myequation}\label{eq:calculo de angulo de la tolva2}
	\begin{split}
		...
		9.81(sin(\beta)-\mu_{k}*cos(\beta))&=\ddot{x}
	\end{split}
\end{myequation}
...
\begin{myfigure}[H]
	...
	\caption[Diagrama esquemático y dependencia de la distancia del objeto seguido por una cámara estéreo.]{(Izquierda) Diagrama esquemático de un objeto representado por dos cámaras alineadas horizontalmente separadas por una pequeña distancia. (Derecha) Dependencia de la distancia del objeto en la disparidad.}
	\begin{myflushleftportland}
