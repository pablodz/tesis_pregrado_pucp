...
\setcounter{tocdepth}{4} % Número de indices a indexar en tabla de contenido 2:section 3:subsection 4:subsubsection
\setcounter{secnumdepth}{4} % Número de indices a indexar en tabla de contenido 2:section 3:subsection 4:subsubsection
...
%\usepackage{fixltx2e} % Corrige bugs de Latex 3 | No es necesario en builds >2015
...
\usepackage{scrextend} % Cambiar formato nota de página
\deffootnote[.5in]{.5in}{.195in}{\makebox[.5in][r]{\thefootnotemark.\hspace{.2in}}}  % Cambiar formato nota de página
% ERROR DE "TITLE ALREADY DEFINED" Pueden omitirlo, no afecta en nada, pueden comentarlo incluso en el archivo.sty
...
\usepackage[hyperfootnotes=false]{hyperref} % Evitar enlaces en bibliografía largos & enlazar enlaces de bibliografía ADEMAS, false porque así lo recomienda la libreria footmisc
\usepackage{natbib}
\usepackage{etoolbox}
...
%\usepackage{svg} % Soporte imagenes svg
% SVG necesita agregar --shel por eso no lo usaremos
...
% FIGURAS
\captionsetup[figure]{font={footnotesize,singlespacing}} % https://bit.ly/2QOHo6U
...
\captionsetup[figure]{justification=centerlast} % Justificado, última linea centrado
...
% TABLAS
\captionsetup[table]{font={footnotesize,singlespacing}} % scriptsize,footnotesize,small,normalsize,larga,Large %stretch=0.8
...
\captionsetup[table]{justification=centerlast} % Justificado, última linea centrado
...
\fancypagestyle{mylandscape}{
	...
	\newgeometry{
		top=3.54cm, % Now top is → right
		bottom=2.54cm, % Now botton is ← left
		left=2.40cm, % Now left is ↑ top
		right=2cm, % Now right is ↓ bottom
	}
}
...
% ENUMERACIÓN arabic Arabic Roman roman
\addto\captionsenglish{
	...
	\renewcommand{\thetable}{Tabla}	
	\renewcommand{\thefigure}{Figura}
...
\renewcommand{\bibsection}{} % Eliminar "References" como título de lista de bibliografía
...
\newcommand{\myarraystrech}{0.75}

\newcommand{\mymaxsizeofcontenttable}{3 cm}
\newcommand{\mysizeimageinsidetable}{1.5 cm}

\newcommand{\mysecondmaxsizeofcontenttable}{5 cm}
\newcommand{\mysecondmaxsizeimageinsidetable}{4 cm}

\newcommand{\mythirdmaxsizeofcontenttable}{2.6 cm}
\newcommand{\mythirdmaxsizeimageinsidetable}{2.4 cm}

\newcommand{\myforthmaxsizeofcontenttable}{4 cm}

\newenvironment{myflushcenter}{%
	\vspace{-1.5em}
	\begin{center}
	}{%
	\end{center}
...
\newenvironment{myflushcenterinsidetable}{%
	\setstretch{0.75}
	\setlength\topsep{0pt}
...
\newenvironment{myflushleftinsidetable}{%
	\setstretch{0.75}
	\setlength\topsep{0pt}
	\setlength\parskip{0pt}
	\begin{flushleft}
...
\newenvironment{myflushcenteraftertable}{%
	\vspace{-0.5 em}
	\begin{center}
	}{%
	\end{center}
...
% Para datos debajo de imagenes en páginas verticales
\newenvironment{myflushleftportland}{%
	\vspace{-1.5em}
	\begin{flushleft} 
	\footnotesize
	}{%
...
% Para datos debajo de tablas en páginas verticales
\newenvironment{myflushleftportland2}{%
	\vspace{-2.5em}
	\begin{flushleft} 
	\footnotesize
	}{%
...
% Para datos debajo de tablas e imagenes en páginas verticales
\newenvironment{myflushleftlandscape}{%
	\vspace{-3em}
	\begin{flushleft} 
	\footnotesize
	}{%
...
% Para evitar espacios luego de nombre de imagen
...
% Para evitar espacios luego de la tabla
...
% Para evitar espacios en ecuaciones
...
%----------------------------------------------------------------------------------------
%	CONFIGURACION DE MARGENES EN TABLA DE CONTENIDOS, COMENTAR SI QUIERES QUE SALGA CON INDENTADOS
%----------------------------------------------------------------------------------------

% Será actualizado en la siguiente versión...

%----------------------------------------------------------------------------------------
%	CONFIGURACION NOTAS DE PAGINA
%----------------------------------------------------------------------------------------

\setlength{\footskip}{25pt} % Elimina espacios luego de notas de pagina