...
\begin{landscape}
	...
	\begin{longtable}{|
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetablelandspace]{chapter3/matriz/boton de emergencia.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetablelandspace]{chapter3/matriz/interruptor de emergencia.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetablelandspace]{chapter3/matriz/interruptor de doble estado de apagado de emergencia.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{3}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/switch.png} \\ 
				\begin{myflushcenter}
					{\footnotesize Switch}
				\end{myflushcenter}
			\end{minipage}
		...
		\multicolumn{3}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/interruptor tipo boton.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{3}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/interruptor tipo hongo.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{3}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/interruptor tipo palanca.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{3}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/interruptor tipo deslizante.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/valvula accionada por servomotor.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/valvula de compuertas.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/rejas de impedimento accionadas por motor.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/electrovalvula solenoide.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/electrovalvula de accion indirecta.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/electrovalvula de accion mixta.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{3}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/bomba de agua centrifuga.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{3}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/bomba de agua sumergible.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{3}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/bomba de agua de refuerzo.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{3}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/electrobomba.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{3}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/motobomba.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{8}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/led de alta potencia.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{7}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/led reflector.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/camara simple.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/camara estereo.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/camara infrarroja.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{8}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/servomotor.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{7}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/actuador electrico.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/timbre.png} \\ 
				\begin{myflushcenter}
					{\footnotesize Timbre}
				\end{myflushcenter}
			\end{minipage}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/bocina.png} \\ 
				\begin{myflushcenter}
					{\footnotesize Bocina}
				\end{myflushcenter}
			\end{minipage}
		...
		\multicolumn{5}{c|}{
			\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/indicador visual.png} \\ 
				\begin{myflushcenter}
	...
	\begin{longtable}{|
		...
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/microcontrolador.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Microcontrolador}
			\end{myflushcenter}
		\end{minipage} &
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/controlador logico programable.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Controlador lógico programable}
			\end{myflushcenter}
		\end{minipage} &
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/computadora monoplaca.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Computadora monoplaca}
			\end{myflushcenter}
		\end{minipage} &
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/computadora ordinaria.png} \\ 
			\begin{myflushcenter}
	...
	\begin{longtable}{|
		...
		\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/fuente de alimentacion.png} \\ 
				\begin{myflushcenter}
		...
		\multirow{-3}{*}{
		\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/variador de voltaje.png} \\ 
				\begin{myflushcenter}
		...
		\multirow{-5}{*}{
		\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/transformador rectificador.png} \\ 
				\begin{myflushcenter}
		...
		\multirow{-3}{*}{
		\begin{minipage}{\mymaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/fuente switching.png} \\ 
				\begin{myflushcenter}
	...
	\begin{longtable}{|
		...
		\begin{minipage}{\mythirdmaxsizeofcontenttable}
			\vspace{-1.5cm}
			\centering\includegraphics[width=\mythirdmaxsizeimageinsidetable]{chapter3/matriz/aplicacion en celular.png} \\ 
			\begin{myflushcenter}
				Aplicación móvil
			\end{myflushcenter}
		\end{minipage} 
		...
		\begin{minipage}{\mythirdmaxsizeofcontenttable}
			\vspace{-1.0cm}
			\centering\includegraphics[width=\mythirdmaxsizeimageinsidetable]{chapter3/matriz/interfaz con el usuario en computadora.png} \\ 
			\begin{myflushcenter}
				Interfaz en computadora
			\end{myflushcenter}
		\end{minipage} 
		} &
		\multirow{-4}{*}{			
		\begin{minipage}{\mythirdmaxsizeofcontenttable}
			\vspace{-1.0cm}
			\centering\includegraphics[width=\mythirdmaxsizeimageinsidetable]{chapter3/matriz/panel de control con botones e indicadores.png} \\ 
			\begin{myflushcenter}
				Interfaz en computadora
			\end{myflushcenter}
		\end{minipage} 
	...
	\begin{longtable}{|
		...
		Recepcionar truchas & \multicolumn{3}{c|}{
			\begin{minipage}{\mysecondmaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysecondmaxsizeimageinsidetable]{chapter3/matriz/tolva.png} \\ 
				\begin{myflushcenter}
					{\footnotesize Tolva}
				\end{myflushcenter}
		\end{minipage}}                     & \multicolumn{3}{c|}{
			\begin{minipage}{\mysecondmaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysecondmaxsizeimageinsidetable]{chapter3/matriz/malla.png} \\ 
				\begin{myflushcenter}
					{\footnotesize Malla}
				\end{myflushcenter}
		\end{minipage}}                             \\ \hline
		...
		\multicolumn{2}{c|}{		
			\begin{minipage}{\mysecondmaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysecondmaxsizeimageinsidetable]{chapter3/matriz/inyeccion de caudal.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{2}{c|}{
			\begin{minipage}{\mysecondmaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysecondmaxsizeimageinsidetable]{chapter3/matriz/juego de pistones.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{2}{c|}{
			\begin{minipage}{\mysecondmaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysecondmaxsizeimageinsidetable]{chapter3/matriz/cadenas transportadoras.png} \\ 
				\begin{myflushcenter}
		...
		\end{minipage}} & \multicolumn{2}{c|}{
			\begin{minipage}{\mysecondmaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysecondmaxsizeimageinsidetable]{chapter3/matriz/filtro de tamano.png} \\ 
				\begin{myflushcenter}
					{\footnotesize Filtros de tamaño}
				\end{myflushcenter}
		\end{minipage}} & \multicolumn{2}{c|}{
			\begin{minipage}{\mysecondmaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysecondmaxsizeimageinsidetable]{chapter3/matriz/filtro unico.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{2}{c|}{
			\begin{minipage}{\mysecondmaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysecondmaxsizeimageinsidetable]{chapter3/matriz/multiples compuertas programables.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{2}{c|}{
			\begin{minipage}{\mysecondmaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysecondmaxsizeimageinsidetable]{chapter3/matriz/compuerta unica programable.png} \\ 
				\begin{myflushcenter}
		...
		\multicolumn{2}{c|}{
			\begin{minipage}{\mysecondmaxsizeofcontenttable}
				\footnotesize\centering\includegraphics[width=\mysecondmaxsizeimageinsidetable]{chapter3/matriz/dimensionalidad.png} \\ 
				\begin{myflushcenter}
	...
	\begin{longtable}{|
		...
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/sensor de presencia.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Sensor de presencia}
			\end{myflushcenter}
		\end{minipage} &		
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/fotorresistencia y laser.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Fotorresistencia y láser}
			\end{myflushcenter}
		\end{minipage} &		
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/sensor infrarrojo.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Sensor infrarrojo}
			\end{myflushcenter}
		\end{minipage} &		
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/sensor de ultrasonido.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Sensor de ultrasonido}
			\end{myflushcenter}
		\end{minipage} &		
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/sensor de peso.png} \\ 
			\begin{myflushcenter}
		...
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/sensor de caudal.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Sensor de caudal}
			\end{myflushcenter}
		\end{minipage} &
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/rotametro electronico.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Rotámetro electrónico}
			\end{myflushcenter}
		\end{minipage} &
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/tubo de venturi y sensor de presion.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Tubos de Venturi y sensor de presión}
			\end{myflushcenter}
		\end{minipage} &
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/medidor de flujo de velocidad.png} \\ 
			\begin{myflushcenter}
				{\footnotesize Medidor de flujo de velocidad}
			\end{myflushcenter}
		\end{minipage} &
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/sensor de presion liquida.png} \\ 
			\begin{myflushcenter}
		...
		\multicolumn{5}{c|}{
		\begin{minipage}{\mymaxsizeofcontenttable}
			\footnotesize\centering\includegraphics[width=\mysizeimageinsidetable]{chapter3/matriz/sensor electronico.png} \\ 
				\begin{myflushcenter}
...
\begin{myfigure}[H]
	\footnotesize\centering
	\includegraphics[width=1\textwidth]{chapter3/concepto virtual del concepto de solucion 2.pdf}
